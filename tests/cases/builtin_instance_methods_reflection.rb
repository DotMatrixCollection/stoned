...
puts NilClass.instance_methods.include?(:to_a)
puts NilClass.instance_methods.include?(:!)
puts TrueClass.instance_methods.include?(:!)
puts FalseClass.instance_methods.include?(:inspect)
