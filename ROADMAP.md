...
- tighten command-style call parsing in the remaining edge cases beyond current keyword-hash, multiline-arg, nested-comma precedence, and covered block-binding parity
