...
int builtin_method_arity(const char *mname) {
    ...
    static const char *zero[] = {
        ...
        "each","map","collect","select","find_all","filter","reject","find","detect","any?","all?",
        "none?","grep","grep_v","each_with_index","flat_map","collect_concat","group_by","sort_by",
...
static int builtin_primitive_responds_to(Value recv, const char *name) {
    ...
    static const char *hash_methods[] = {
        ...
        "reject", "any?", "all?", "none?", "find", "detect", "grep", "grep_v",
    ...
    static const char *range_methods[] = {
        ...
        "map", "collect", "select", "find_all", "filter", "reject", "grep", "grep_v",
        "to_s", "inspect", NULL
    };
